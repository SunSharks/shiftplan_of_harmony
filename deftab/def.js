...
function create_jobbox(){
  ...
  let helper_check_box_div = document.createElement('div');
  helper_check_box_div.setAttribute("class", "jobbox");
  var helper_check_box = document.createElement('checkbox');
  helper_check_box.setAttribute("class", "jobbox");
  helper_check_box.setAttribute("id", "helper"+id.toString());
  helper_check_box.setAttribute("name", "helper"+id.toString());
  helper_check_box.setAttribute("value", "helper"+id.toString());
  helper_check_box.innerHTML = "<input type='checkbox' name='helper" + id.toString() + "'>";
  helper_check_box_div.appendChild(helper_check_box);
  outer_div.appendChild(helper_check_box_div);

  let helper_label_div = document.createElement('div');
  helper_label_div.setAttribute("class", "jobbox");
  let helper_label = document.createElement('label');
  helper_label.setAttribute("class", "jobbox");
  helper_label.setAttribute("for", "checkbox");
  helper_label.setAttribute("name", "helper_label"+id.toString());
  helper_label.setAttribute("id", "helper_label"+id.toString());
  helper_label.innerHTML = "Helper";
  helper_label_div.appendChild(helper_label);
  outer_div.appendChild(helper_label_div);

  let special_check_box_div = document.createElement('div');
  special_check_box_div.setAttribute("class", "jobbox");
  var special_check_box = document.createElement('checkbox');
  special_check_box.setAttribute("class", "jobbox");
  special_check_box.setAttribute("id", "special"+id.toString());
  special_check_box.setAttribute("name", "special"+id.toString());
  special_check_box.setAttribute("value", "special"+id.toString());
  special_check_box.innerHTML = "<input type='checkbox' name='special" + id.toString() + "'>";
  special_check_box_div.appendChild(special_check_box);
  outer_div.appendChild(special_check_box_div);

  let special_label_div = document.createElement('div');
  special_label_div.setAttribute("class", "jobbox");
  let special_label = document.createElement('label');
  special_label.setAttribute("class", "jobbox");
  special_label.setAttribute("for", "checkbox");
  special_label.setAttribute("name", "special_label"+id.toString());
  special_label.setAttribute("id", "special_label"+id.toString());
  special_label.innerHTML = "sensibel";
...
function delete_jobbox(id){
  ...
  el.remove();
  numjobs--;
  const e = document.getElementById("helper_label"+id.toString());
  e.remove();
  const cb = document.getElementById("helper"+id.toString());
  cb.remove();
  const sp = document.getElementById("special_label"+id.toString());
  sp.remove();
  const spd = document.getElementById("special"+id.toString());
  spd.remove();
