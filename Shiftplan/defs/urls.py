...
urlpatterns = [
    ...
    path('create/', create_shiftplan, name='create-shiftplan'),
    path('<int:pk>/time_def/', time_def, name='time-def'),
    path('<int:pk>/ti/', time_interval_def, name='ti_def'),
    path('<int:pk>/ti/create/', create_time_interval, name='create_ti'),
    path('ti/create-ti-form/', create_time_interval_form, name='create-ti-form'),
    path('ti/<int:pk>/delete/', delete_time_interval, name='delete_ti'),
    path('ti/<int:pk>/update/', update_time_interval, name='update_ti'),
    ...
    path('<int:pk>/job/bulk_create/', bulk_create_jobs, name='bulk-create-jobs')
]
